...
[![VS Code Marketplace](https://img.shields.io/visual-studio-marketplace/v/hernandor.duckdb?label=VS%20Code%20Marketplace)](https://marketplace.visualstudio.com/items?itemName=hernandor.duckdb)
[![Open VSX](https://img.shields.io/open-vsx/v/hernandor/duckdb?label=Open%20VSX)](https://open-vsx.org/extension/hernandor/duckdb)
...
The fork is published under the `hernandor` publisher ID for one practical reason: I need to install the extension conveniently across several machines, and the changes below have not been merged upstream. If they land upstream, the original extension is the one to use.
